...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var characters:Array<String> = ["bf", 'dad', 'gf', 'spooky', 'monster', 'pico', 'mom', 'carol'];
		var stages:Array<String> = ["stage", "spooky", "philly", "limo"];
		var stageDropdown = new FlxUIDropDownMenu(10,200,FlxUIDropDownMenu.makeStrIdLabelArray(stages, true),function(stage:String){
